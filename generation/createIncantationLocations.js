		...
		sections: [
			{
				...
				access_rules: [and(vars.Items.Gigaros, CanReach(vars.LocNames.Bosses.Chronos), CanReach(vars.LocNames.Bosses.Typhon))],
			...
			},
			{
				...
				access_rules: [and(vars.Incants.Mercantile, CanReach(vars.LocNames.Bosses.Hecate))],
			...
			},
			{
				...
				access_rules: [and(vars.Incants.FaithFamiliar, CanReach(vars.LocNames.Areas.Fields), CanReach(vars.LocNames.Bosses.Polyphemus))] // +4 Witch's Delight?
			},
			{
			...
			},
			{
				...
				access_rules: [and(vars.Incants.AlterationFamiliar, vars.Incants.Mercantile)] // +Social Solidarity?
			},
			{
				name: "Acceptance of Another Fate",
				access_rules: [and(vars.Incants.InsightOffering, CanReach(vars.LocNames.Bosses.Chronos), CanReach(vars.LocNames.Bosses.Typhon))] // +Spreading Ashes? +Favored Keepsakes?
			},
			{
			...
			{
				name: "Forget-Me-Not",
				access_rules: [and(vars.Incants.FlourishingSoil, vars.Incants.FatedIntervention)],
				hosted_item: vars.Incants.ForgetMeNot
			},
			{
				name: "Path to Desired Blessings",
				access_rules: [and(vars.Incants.ForgetMeNot, vars.Incants.InsightOffering, CanReach(vars.LocNames.Bosses.Chronos), CanReach(vars.LocNames.Bosses.Typhon))]
			},
			{
			...
			},
			{
				...
				access_rules: [and(vars.Incants.NightsCraftwork, vars.Incants.Mercantile)]
			},
			{
			...
			},
			{
				...
				access_rules: [and(CanReach(vars.LocNames.Bosses.Scylla), CanReach(vars.LocNames.Bosses.Eris))],
				hosted_item: vars.Incants.DepthsAndSea
			},
			{
				name: "Rivals of Plain and Peak",
				access_rules: [and(vars.Incants.DepthsAndSea, CanReach(vars.LocNames.Bosses.Cerberus), CanReach(vars.LocNames.Bosses.Prometheus))],
				hosted_item: vars.Incants.PlainAndPeak
			},
			{
				name: "Rivals of Old and Rot",
				access_rules: [and(vars.Incants.DepthsAndSea, vars.Incants.Dissolution)],
			...
			},
			{
				...
				access_rules: [and(vars.Incants.RiseWells, vars.Incants.CleansingWaters, CanReach(vars.LocNames.Areas.Fields))], // +balance?
				hosted_item: vars.Incants.SurgeWells
			},
			{
				name: "Rush of Fresh Air",
				access_rules: [and(vars.Incants.RiseWells, vars.Incants.Unraveling, vars.Incants.Bats, CanReach(vars.LocNames.Areas.Thessaly))],
				hosted_item: vars.Incants.RushAir
			},
			{
				name: "Surge of Fresh Air",
				access_rules: [and(vars.Incants.RushAir, CanReach(vars.LocNames.Bosses.Polyphemus))], // +balance?
			...
			},
			{
				...
				access_rules: [and(vars.Incants.RevivalPool, CanReach(vars.LocNames.Bosses.Chronos))]
			},
			{
				name: "Woodsy Lifespring",
				access_rules: [and(vars.Incants.ReagentSensing, vars.Incants.ForgetMeNot)],
			...
			},
			{
				...
				access_rules: [and(vars.Incants.BrinyLifespring, vars.Incants.DeathlyFortune, CanReach(vars.LocNames.Areas.Tartarus))] // or Chronos? Must fight him at least once
			},
			{
				name: "Sandy Lifespring",
				access_rules: [and(vars.Incants.BrinyLifespring, CanReach(vars.LocNames.Areas.Thessaly))] // or Eris? Must fight her at least once
			},
			{
				name: "Frozen Lifespring",
				access_rules: [and(vars.Incants.SandyLifespring, CanReach(vars.LocNames.Areas.Olympus))]
			},
			{
			...
			},
			{
				...
				access_rules: [and(vars.Incants.Mercantile, vars.Weapons.LimAndOros, vars.Incants.ReagentSensing, CanReach(vars.LocNames.Areas.Oceanus))],
			...
			},
			{
				...
				access_rules: [and(vars.Incants.ExhumedTroves, vars.Incants.NecromanticInfluence, vars.Incants.SurgeAir, CanReach(vars.LocNames.Areas.Olympus))],
			...
			{
				name: "Exhumed Troves",
				access_rules: [and(vars.Incants.KindredKeepsakes, vars.Incants.Mercantile, vars.Incants.SurgeWells)],
				hosted_item: vars.Incants.ExhumedTroves
			},
			{
				name: "Eyes of Night and Darkness",
				access_rules: [and(vars.Incants.ArisenTroves, CanReach(vars.LocNames.Bosses.Chronos), CanReach(vars.LocNames.Areas.Olympus))]
			},
			{
				name: "Arisen Troves",
				access_rules: [and(vars.Incants.ExhumedTroves, CanReach(vars.LocNames.Bosses.Eris))],
			...
			{
				name: "Rich Soil",
				access_rules: [and(vars.Incants.FlourishingSoil, CanReach(vars.LocNames.Areas.Fields))],
				hosted_item: vars.Incants.RichSoil
			},
			{
				name: "Verdant Soil",
				access_rules: [and(vars.Incants.RichSoil, CanReach(vars.LocNames.Areas.Tartarus), CanReach(vars.LocNames.Areas.Olympus))],
				hosted_item: vars.Incants.VerdantSoil
			},
			{
				name: "Observance of Gaia's Secrets",
				access_rules: [and(vars.Incants.VerdantSoil, vars.Incants.GreatFavorGaia)],
				hosted_item: vars.Incants.ObservanceGaia
			},
			{
				name: "Green Hand of Gaia",
				access_rules: [and(vars.Incants.ObservanceGaia, CanReach(vars.LocNames.Areas.Summit))] // +90 seeds?
			},
			{
			...
			},
			{
				...
				access_rules: [and(vars.Incants.SocialSolidarity, vars.Incants.EarthlyFortune, CanReach(vars.LocNames.Bosses.Cerberus))],
				hosted_item: vars.Incants.Rhapsody
			},
			{
				name: "Shuffling of Noted Ballads",
				access_rules: [and(vars.Incants.Rhapsody, CanReach(vars.LocNames.Areas.Tartarus), CanReach(vars.LocNames.Areas.Olympus))]
			},
			{
			...
			},
			{
				...
				access_rules: [and(vars.Incants.Mercantile, vars.Incants.SocialSolidarity, CanReach(vars.LocNames.Bosses.Chronos))]
			},
			{
